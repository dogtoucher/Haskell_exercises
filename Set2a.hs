...
safeIndex xs i = if i>=0 && length xs > i then Just (xs !! i) else Nothing
...
addEithers (Left str1) (Left str2) = Left str1
addEithers (Right num1) (Left str2) = Left str2
addEithers (Left str1) (Right num2) = Left str1
