...
largestHelper x [] = [x]
largestHelper x list = let f = head(list) in if x>f then [x] 
                                             else if x==f then (f:list) 
                                             else list 
